...
/**
 * Extends stancl's provider so service container bindings and asset routes stay registered
 * while we add NexStay tenant lifecycle and route groups.
 */
class TenancyServiceProvider extends StanclTenancyServiceProvider
{
    ...
    protected function bootTenantEventListeners(): void
    {
